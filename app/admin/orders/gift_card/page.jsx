  ...
  return (
    <AppLayout title={"Summary on Gift cards orders"}>
      <div className="grid sm:grid-cols-3 gap-5">
        <AppCard figure={20034535} icon={<i class="ri-exchange-funds-line"></i>} color="text-[#000000]" text="Total Gift card orders" bg="bg-[#000000]" />
        <AppCard figure={43053} icon={<i class="ri-pass-pending-line"></i>} color="text-[#fff444]" text="Pending Gift card orders" bg="bg-[#fff444]" />
        <AppCard figure={52344} icon={<i class="ri-bard-line"></i>} color="text-[#11c9a4]" text="Completed Gift card orders" bg="bg-[#11c9a4]" />
      </div>
      <div className="">
